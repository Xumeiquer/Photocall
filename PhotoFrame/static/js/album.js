    ...
    success: (data) => {
      ...
      $.each(data.albums, (i, item) => {
        ...
        const materialDesignLiteList =
            $('<li id="list"/>').addClass('mdl-list__item mdl-list__item--two-line');
...
//TODO: CHanged to be the name the link to add
        ...
        primaryContentRoot.append(primaryLink);
       ...
       const linkToAddToPhotoFrame = $('<a />')
        ...
        // The 'open in Google Photos' link. // TODO: CHANGED disabled
...
*/
      ...
      $("li").each(function(index){console.log("hey",index);$(this).css("width","100%")});

      hideLoadingDialog();
      console.log('Albums loaded. (in album.js)');
    },
    error: (data) => {
      hideLoadingDialog();
